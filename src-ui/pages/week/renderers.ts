  ...
  return `
    <section class="week-right-section week-right-section--status">
      ...
      <div class="week-status-card">
        <span class="pill week-status-pill">${phaseLabel.toUpperCase()}</span>
        <div class="week-status-time" data-week-status-time>${toTimerText(displayRemainingSeconds)}</div>
        <p class="week-status-subtitle">REMAINING</p>
        <p class="week-status-title">${escapeHtml(focusTask?.title || currentTitle)}</p>
